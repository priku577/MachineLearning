...
my_tweet<-searchTwitter("ISIS",n=50,lang="en",since='2017-12-01',until='2018-05-02',retryOnRateLimit=250)
...
score.sentiment = function(sentences, pos.words, neg.words)
{
  ...
  dataframe <-unlist(sapply(sentences, `[`))
  scores.df = data.frame(score = score_new, text=dataframe)
  positive.df = data.frame(Positive = pp1, text=dataframe)
  negative.df = data.frame(Negative = nn1, text=dataframe)
